...
Vagrant.configure(VAGRANTFILE_API_VERSION) do |config|
  ...
  #
  config.vm.network "forwarded_port", guest: 3000, host: 4150

  # Install linux packages
  #
  config.vm.provision :shell, path: "https://github.com/mopineyro/pick6-vagrant/raw/master/script/vagrant_bootstrap.sh", privileged: false
